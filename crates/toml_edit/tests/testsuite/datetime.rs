...
fn bad_times() {
    ...
    bad!("foo = 1997-09-9", str![[r#"
        ...
        invalid date-time
    "#]]);
    bad!("foo = 1997-09-0909:09:09", str![[r#"
        ...
        expected newline, `#`
    "#]]);
    bad!("foo = 1997-09-09T09:09:09.", str![[r#"
    ...
    bad!("foo = TZ", str![[r#"
        ...
        expected `"`, `'`
    "#]]);
    bad!("foo = 1997-09-09T09:09:09.09+", str![[r#"
        ...
        invalid time offset
    "#]]);
    bad!("foo = 1997-09-09T09:09:09.09+09", str![[r#"
        ...
        invalid time offset
    "#]]);
    bad!("foo = 1997-09-09T09:09:09.09+09:9", str![[r#"
        ...
        invalid time offset
    "#]]);
    bad!("foo = 1997-09-09T09:09:09.09+0909", str![[r#"
        TOML parse error at line 1, column 32
          |
    ...
    bad!("foo = 1997-00-09T09:09:09.09Z", str![[r#"
        TOML parse error at line 1, column 12
          |
    ...
    "#]]);
    bad!("foo = 1997-09-00T09:09:09.09Z", str![[r#"
        TOML parse error at line 1, column 15
          |
        ...
        value is out of range
    "#]]);
    bad!("foo = 1997-09-09T30:09:09.09Z", str![[r#"
        TOML parse error at line 1, column 17
          |
        ...
        expected newline, `#`
    "#]]);
    bad!("foo = 1997-09-09T12:69:09.09Z", str![[r#"
        ...
        value is out of range
    "#]]);
    bad!("foo = 1997-09-09T12:09:69.09Z", str![[r#"
