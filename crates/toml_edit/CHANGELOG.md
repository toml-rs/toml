...
- Prevent `Table::set_position` from moving a table before the root table
...
- Allow dotted keys to extend implicit tables
...
[0.25.2]: https://github.com/toml-rs/toml/compare/v0.25.1...v0.25.2
