...
impl SerializeDocument {
    pub(crate) fn new() -> Self {
        Self {
            inner: SerializeTable::new(),
        }
    }

    pub(crate) fn with_capacity(len: usize) -> Self {
        Self {
            inner: SerializeTable::with_capacity(len),
        }
    }
}

impl serde::ser::SerializeMap for SerializeDocument {
...
impl serde::ser::SerializeStruct for SerializeDocument {
    type Ok = crate::Document;
    type Error = Error;
...
pub(crate) struct SerializeTable {
...
impl serde::ser::SerializeMap for SerializeTable {
    type Ok = crate::Table;
    type Error = Error;
    ...
    fn end(self) -> Result<Self::Ok, Self::Error> {
        self.inner.end().map(|items| crate::Table {
            items,
            ..Default::default()
        })
    }
...
impl serde::ser::SerializeStruct for SerializeTable {
    type Ok = crate::Table;
    type Error = Error;
...
pub(crate) struct SerializeItemTable {
    inner: SerializeKeyValuePairs,
}
